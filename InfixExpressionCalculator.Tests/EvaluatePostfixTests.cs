...
namespace InfixExpressionCalculator.Tests
{
    ...
    public class The_EvaluatePostfix_Method
    {
        ...
        public void Should_Throw_An_Exception_When_Dividing_By_Zero(string postfix)
        {
        ...
        public void Should_Throw_An_Exception_When_Given_A_Postfix_Expression_With_Too_Many_Operators(string postfix)
        {
            InfixExpressionCalculator.EvaluatePostfix(postfix);
        }
        ...
        public void Should_Throw_An_Exception_When_Given_A_Postfix_Expression_With_Invalid_Numbers(string postfix)
        {
            InfixExpressionCalculator.EvaluatePostfix(postfix);
        }
    }
